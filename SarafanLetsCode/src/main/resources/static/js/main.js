...
Vue.component('message-form', {
    ...
    watch: {
        messageAttr: function(newValueOfMessage, oldValueOfMessage){
            this.text = newValueOfMessage.text;
            this.id = newValueOfMessage.id

        }
    },
    template: '<div>' +
        '<input type="text" placeholder="Напиши что-нибудь, а" v-model="text"/>' +
        '<input type="button" class="btn btn-primary" value="Сохранить" @click="save"/>' +
        '</div>',
    methods: {
        save: function () {
